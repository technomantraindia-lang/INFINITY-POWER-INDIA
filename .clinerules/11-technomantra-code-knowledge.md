...
- UI industries.css: .ind-hero, #ffffff, .container, .ind-hero-badge, #ff4d4f, #d1d5db, .ind-breadcrumbs, #e5e7eb, #ef4444, .red-eyebrow-accent, #e52327, .section-center-head, .section-center-head--dark, .ind-power-section
- UI animations.css: .js-anim, #e52327
- UI inquiry.css: .inquiry-modal, .inquiry-modal__overlay, .inquiry-modal__dialog, #ffffff, .inquiry-modal__close, #f1f5f9, #e52327, .inquiry-modal__badge, .inquiry-modal__title, .inquiry-modal__sub, .inq-row, .inq-field, .req, #e2e8f0
- UI contact.css: .contact-hero, #fff, .contact-hero-badge, #ff4d4f, #cbd5e1, .contact-breadcrumbs, .separator, .current, .contact-main, #ffffff, .contact-main-grid, .info-card, .info-intro, .info-item
...
- UI career.html: #home, #main-nav, #openings, #footer, .topbar, .container, .topbar__inner, .contact-mini, .social-mini, .site-header, .header__inner, .brand, .site-logo-img, .menu-toggle
- UI downloads.css: .dl-hero, #ffffff, .container, .dl-hero-badge, #ff4d4f, #d1d5db, .dl-breadcrumbs, #e5e7eb, #ef4444, .red-eyebrow-text, #e52327, .section-center-head, .dl-grid-section, .dl-filter-pills
